...
public class NullableListOfNullableDoublesDefaultValueTurtle {
    ...
    public void testDefaultValueEquality() throws IOException {
        ...
        DoubleAsserts.assertNullableListOfNullableEquals(defaultValue, defaultValueJsonDeserialized);
    }
    ...
    public void testBorderValue1Equality() throws IOException {
        ...
        DoubleAsserts.assertNullableListOfNullableEquals(borderValue1, borderValue1JsonDeserialized);
    }
    ...
    public void testBorderValue2Equality() throws IOException {
        ...
        DoubleAsserts.assertNullableListOfNullableEquals(borderValue2, borderValue2JsonDeserialized);
    }
    ...
    public void testBorderValue3Equality() throws IOException {
        ...
        DoubleAsserts.assertNullableListOfNullableEquals(borderValue3, borderValue3JsonDeserialized);
    }
    ...
    public void testBorderValue4Equality() throws IOException {
        ...
        DoubleAsserts.assertNullableListOfNullableEquals(borderValue4, borderValue4JsonDeserialized);
    }

    @org.junit.Test
    public void testBorderValue5Equality() throws IOException {
        final java.util.List<Double> borderValue5 = new java.util.ArrayList<Double>(java.util.Arrays.asList(null, 0.0, 1E-307, 9E307, -1.23456789012345E-10, 1.23456789012345E20, Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, Double.NaN));
        ...
        DoubleAsserts.assertNullableListOfNullableEquals(borderValue5, borderValue5JsonDeserialized);
    }
}
