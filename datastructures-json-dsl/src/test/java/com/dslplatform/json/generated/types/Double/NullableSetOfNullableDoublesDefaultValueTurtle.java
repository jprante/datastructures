...
public class NullableSetOfNullableDoublesDefaultValueTurtle {
    ...
    public void testDefaultValueEquality() throws IOException {
        ...
        DoubleAsserts.assertNullableSetOfNullableEquals(defaultValue, defaultValueJsonDeserialized);
    }
    ...
    public void testBorderValue1Equality() throws IOException {
        ...
        DoubleAsserts.assertNullableSetOfNullableEquals(borderValue1, borderValue1JsonDeserialized);
    }
    ...
    public void testBorderValue2Equality() throws IOException {
        ...
        DoubleAsserts.assertNullableSetOfNullableEquals(borderValue2, borderValue2JsonDeserialized);
    }
    ...
    public void testBorderValue3Equality() throws IOException {
        ...
        DoubleAsserts.assertNullableSetOfNullableEquals(borderValue3, borderValue3JsonDeserialized);
    }
    ...
    public void testBorderValue4Equality() throws IOException {
        ...
        DoubleAsserts.assertNullableSetOfNullableEquals(borderValue4, borderValue4JsonDeserialized);
    }

    @org.junit.Test
    public void testBorderValue5Equality() throws IOException {
        final java.util.Set<Double> borderValue5 = new java.util.HashSet<Double>(java.util.Arrays.asList(null, 0.0, 1E-307, 9E307, -1.23456789012345E-10, 1.23456789012345E20, Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, Double.NaN));
        ...
        DoubleAsserts.assertNullableSetOfNullableEquals(borderValue5, borderValue5JsonDeserialized);
    }
}
