...
public class NullableSetOfNullableGuidsDefaultValueTurtle {
    ...
    public void testDefaultValueEquality() throws IOException {
        ...
        GuidAsserts.assertNullableSetOfNullableEquals(defaultValue, defaultValueJsonDeserialized);
    }
    ...
    public void testBorderValue1Equality() throws IOException {
        ...
        GuidAsserts.assertNullableSetOfNullableEquals(borderValue1, borderValue1JsonDeserialized);
    }
    ...
    public void testBorderValue2Equality() throws IOException {
        ...
        GuidAsserts.assertNullableSetOfNullableEquals(borderValue2, borderValue2JsonDeserialized);
    }
    ...
    public void testBorderValue3Equality() throws IOException {
        ...
        GuidAsserts.assertNullableSetOfNullableEquals(borderValue3, borderValue3JsonDeserialized);
    }
    ...
    public void testBorderValue4Equality() throws IOException {
        ...
        GuidAsserts.assertNullableSetOfNullableEquals(borderValue4, borderValue4JsonDeserialized);
    }

    @org.junit.Test
    public void testBorderValue5Equality() throws IOException {
        final java.util.Set<java.util.UUID> borderValue5 = new java.util.HashSet<java.util.UUID>(java.util.Arrays.asList(null, java.util.UUID.randomUUID(), java.util.UUID.fromString("1-2-3-4-5"), new java.util.UUID(0L, 0L)));
        ...
        GuidAsserts.assertNullableSetOfNullableEquals(borderValue5, borderValue5JsonDeserialized);
    }
}
