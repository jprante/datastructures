...
public class NullableSetOfNullableImagesDefaultValueTurtle {
    ...
    public void testDefaultValueEquality() throws IOException {
        ...
        ImageAsserts.assertNullableSetOfNullableEquals(defaultValue, defaultValueJsonDeserialized);
    }
    ...
    public void testBorderValue1Equality() throws IOException {
        ...
        ImageAsserts.assertNullableSetOfNullableEquals(borderValue1, borderValue1JsonDeserialized);
    }
    ...
    public void testBorderValue2Equality() throws IOException {
        ...
        ImageAsserts.assertNullableSetOfNullableEquals(borderValue2, borderValue2JsonDeserialized);
    }
    ...
    public void testBorderValue3Equality() throws IOException {
        ...
        ImageAsserts.assertNullableSetOfNullableEquals(borderValue3, borderValue3JsonDeserialized);
    }
    ...
    public void testBorderValue4Equality() throws IOException {
        ...
        ImageAsserts.assertNullableSetOfNullableEquals(borderValue4, borderValue4JsonDeserialized);
    }

    @org.junit.Test
    public void testBorderValue5Equality() throws IOException {
        final java.util.Set<java.awt.image.BufferedImage> borderValue5 = new java.util.HashSet<java.awt.image.BufferedImage>(java.util.Arrays.asList(null, new java.awt.image.BufferedImage(1, 1, java.awt.image.BufferedImage.TYPE_4BYTE_ABGR), new java.awt.image.BufferedImage(2, 2, java.awt.image.BufferedImage.TYPE_3BYTE_BGR), new java.awt.image.BufferedImage(3, 3, java.awt.image.BufferedImage.TYPE_BYTE_BINARY), new java.awt.image.BufferedImage(4, 4, java.awt.image.BufferedImage.TYPE_BYTE_GRAY), new java.awt.image.BufferedImage(5, 5, java.awt.image.BufferedImage.TYPE_BYTE_INDEXED), new java.awt.image.BufferedImage(6, 6, java.awt.image.BufferedImage.TYPE_INT_RGB)));
        ...
        ImageAsserts.assertNullableSetOfNullableEquals(borderValue5, borderValue5JsonDeserialized);
    }
}
