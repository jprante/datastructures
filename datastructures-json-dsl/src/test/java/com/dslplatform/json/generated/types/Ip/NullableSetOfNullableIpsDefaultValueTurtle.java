...
public class NullableSetOfNullableIpsDefaultValueTurtle {
    ...
    public void testDefaultValueEquality() throws IOException {
        ...
        IpAsserts.assertNullableSetOfNullableEquals(defaultValue, defaultValueJsonDeserialized);
    }
    ...
    public void testBorderValue1Equality() throws IOException {
        ...
        IpAsserts.assertNullableSetOfNullableEquals(borderValue1, borderValue1JsonDeserialized);
    }
    ...
    public void testBorderValue2Equality() throws IOException {
        ...
        IpAsserts.assertNullableSetOfNullableEquals(borderValue2, borderValue2JsonDeserialized);
    }
    ...
    public void testBorderValue3Equality() throws IOException {
        ...
        IpAsserts.assertNullableSetOfNullableEquals(borderValue3, borderValue3JsonDeserialized);
    }

    @org.junit.Test
    public void testBorderValue4Equality() throws IOException {
        final java.util.Set<java.net.InetAddress> borderValue4 = new java.util.HashSet<java.net.InetAddress>(java.util.Arrays.asList(null, TypeFactory.buildIP("127.0.0.1"), TypeFactory.buildIP("0"), TypeFactory.buildIP("255.255.255.255"), TypeFactory.buildIP("::1"), TypeFactory.buildIP("ffff::ffff")));
        ...
        IpAsserts.assertNullableSetOfNullableEquals(borderValue4, borderValue4JsonDeserialized);
    }
}
