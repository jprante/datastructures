...
public class OneIpDefaultValueTurtle {
    ...
    public void testDefaultValueEquality() throws IOException {
        final java.net.InetAddress defaultValue = TypeFactory.buildIP("127.0.0.1");
        ...
        IpAsserts.assertOneEquals(defaultValue, defaultValueJsonDeserialized);
    }

    @org.junit.Test
    public void testBorderValue1Equality() throws IOException {
        final java.net.InetAddress borderValue1 = TypeFactory.buildIP("0");
        ...
        IpAsserts.assertOneEquals(borderValue1, borderValue1JsonDeserialized);
    }

    @org.junit.Test
    public void testBorderValue2Equality() throws IOException {
        final java.net.InetAddress borderValue2 = TypeFactory.buildIP("255.255.255.255");
        ...
        IpAsserts.assertOneEquals(borderValue2, borderValue2JsonDeserialized);
    }

    @org.junit.Test
    public void testBorderValue3Equality() throws IOException {
        final java.net.InetAddress borderValue3 = TypeFactory.buildIP("::1");
        ...
        IpAsserts.assertOneEquals(borderValue3, borderValue3JsonDeserialized);
    }

    @org.junit.Test
    public void testBorderValue4Equality() throws IOException {
        final java.net.InetAddress borderValue4 = TypeFactory.buildIP("ffff::ffff");
        ...
        IpAsserts.assertOneEquals(borderValue4, borderValue4JsonDeserialized);
    }
}
