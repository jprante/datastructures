...
public class DateTimeOnlyTypeDeclaration extends TypeDeclaration<DateTimeOnlyResolvedType> {

    public DateTimeOnlyTypeDeclaration(KeyValueNode node, DateTimeOnlyResolvedType resolvedType) {
