...
public class XFRecord extends WritableRecordData implements CellFormat {
     ...
     * The logger
     */
    private static final Logger logger = Logger.getLogger(XFRecord.class);
    /**
     * The list of built in number format values
     */
    private static final int[] numberFormats = new int[]
            {0x1,
                    0x2,
                    0x3,
                    0x4,
     ...
     */
    private static final NumberFormat[] javaNumberFormats = new NumberFormat[]
            {new DecimalFormat("0"),
     ...
     * The biff type
     */
    private final BiffType biffType;
    ...
    public final boolean hasBorders() {
        ...
        return leftBorder != BorderLineStyle.NONE ||
                rightBorder != BorderLineStyle.NONE ||
                topBorder != BorderLineStyle.NONE ||
                bottomBorder != BorderLineStyle.NONE;
    }
